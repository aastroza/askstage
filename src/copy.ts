...
export const copy = {
  ...
  es: {
    ...
    empty: "Sé la primera persona en preguntar.",
    question: "Tu pregunta",
    questionPlaceholder: "¿Qué te gustaría preguntarle a los speakers?",
    nameOptional: "Nombre (opcional)",
    namePlaceholder: "Tu nombre",
    send: "Enviar pregunta",
    talk: "Charla",
    anonymous: "Anónimo",
    defaultIntro: "Elige la charla, escribe tu pregunta y vota por las que quieres escuchar en vivo.",
